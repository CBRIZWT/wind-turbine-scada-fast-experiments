# -*- coding: utf-8 -*-
"""77 EWMA增强_Stacking堆叠 —— EWMA 分数增强变体。
...
与基模型 39_Stacking堆叠 的唯一差别: 分数经逐机组因果 EWMA(span=12, 即2小时) 平滑。
...
report("77_EWMA增强_Stacking堆叠", yva, sva, yte, ste, now() - t0,
       extra={"增强": "EWMA(span=12, 逐机组因果)", "基模型": "39_Stacking堆叠",
