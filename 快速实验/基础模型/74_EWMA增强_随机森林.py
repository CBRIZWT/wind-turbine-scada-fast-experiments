...
与基模型 08_随机森林 的唯一差别: 分数经逐机组因果 EWMA(span=12, 即2小时) 平滑。
...
report("74_EWMA增强_随机森林", yva, sva, yte, ste, now() - t0,
       extra={"增强": "EWMA(span=12, 逐机组因果)", "基模型": "08_随机森林",
